...
@dag(
    dag_id="local-tester-local-git-test-parallel-my-test-type-my-test-context-my-first-generated-dag-low-fba6da",
    schedule_interval=None,
    default_args=default_args,
    tags=["PARALLEL", "my-test-type", "my-test-context", "my-first-generated-dag", "my-test-context-my-first-generated-dag", "low"],
    catchup=False,
