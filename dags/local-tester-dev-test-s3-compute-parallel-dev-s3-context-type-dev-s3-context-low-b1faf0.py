...
@dag(
    dag_id="local-tester-dev-test-s3-compute-parallel-dev-s3-context-type-dev-s3-context-low-b1faf0",
    schedule_interval=None,
    default_args=default_args,
    tags=["PARALLEL", "dev-s3-context-type", "dev-s3-context", "dev-s3-compute-dag", "dev-s3-context-dev-s3-compute-dag", "low"],
    catchup=False,
