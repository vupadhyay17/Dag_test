...
@dag(
    dag_id="local-tester-local-git-test-sequential-my-test-type-my-test-context-my-first-generated-dag-medium-a83795",
    schedule_interval=None,
    default_args=default_args,
    tags=["SEQUENTIAL", "my-test-type", "my-test-context", "my-first-generated-dag", "my-test-context-my-first-generated-dag", "medium"],
    catchup=False,
