...
@dag(
    dag_id="local-tester-local-git-test-sequential-my-test-type-my-test-context-my-first-generated-dag-high-6eb5c3",
    schedule_interval=None,
    default_args=default_args,
    tags=["SEQUENTIAL", "my-test-type", "my-test-context", "my-first-generated-dag", "my-test-context-my-first-generated-dag", "high"],
    catchup=False,
