...
@dag(
    dag_id="local-tester-local-git-test-sequential-my-test-type-my-test-context-my-first-generated-dag-low-5fb605",
    schedule_interval=None,
    default_args=default_args,
    tags=["SEQUENTIAL", "my-test-type", "my-test-context", "my-first-generated-dag", "my-test-context-my-first-generated-dag", "low"],
    catchup=False,
