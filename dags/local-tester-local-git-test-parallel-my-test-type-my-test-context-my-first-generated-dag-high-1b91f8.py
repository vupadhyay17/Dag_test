...
@dag(
    dag_id="local-tester-local-git-test-parallel-my-test-type-my-test-context-my-first-generated-dag-high-1b91f8",
    schedule_interval=None,
    default_args=default_args,
    tags=["PARALLEL", "my-test-type", "my-test-context", "my-first-generated-dag", "my-test-context-my-first-generated-dag", "high"],
    catchup=False,
