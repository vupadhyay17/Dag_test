...
@dag(
    dag_id="local-tester-dev-test-s3-compute-sascomputedag-medium-01938b",
    schedule_interval=None,
    default_args=default_args,
    tags=["SAS_COMPUTE_DAG", "dev-s3-context-type", "dev-s3-context", "dev-s3-compute-dag", "dev-s3-context-dev-s3-compute-dag", "medium"],
    catchup=False,
